...
use App\Livewire\Guru\ManageRemedials;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:murid')->prefix('murid')->name('murid.')->group(function () {
        ...
        Route::view('assessments/{assessment}/result', 'dashboard.page', ['livewireComponent' => AssessmentResultPage::class, 'title' => 'Hasil Asesmen'])->name('assessments.result');
        Route::view('assessments/{assessment}/review', 'dashboard.page', ['livewireComponent' => AssessmentReviewPage::class, 'title' => 'Review Asesmen'])->name('assessments.review');
